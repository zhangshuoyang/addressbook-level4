...
public class PersonListPanelTest extends GuiUnitTest {
    ...
    private static final JumpToListRequestEvent JUMP_TO_SECOND_EVENT = new JumpToListRequestEvent(INDEX_SECOND_PERSON.get(0));
    ...
    public void handleJumpToListRequestEvent() {
        ...
        PersonCardHandle expectedCard = personListPanelHandle.getPersonCardHandle(INDEX_SECOND_PERSON.get(0).getZeroBased());
