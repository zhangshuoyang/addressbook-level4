...
2.  AddressBook prints suggested commands, whose prefixes are the same as
the text entered by user, in the GUI.
...
* 3b. Prefix entered is incorrectly spelt
** 3b1. AddressBook will not respond.
* 3c. There is only 1 command whose prefix matches
the word typed by the user.
** 3c1. AddressBook replaces the text entered by user, in
the command bar, by the matching command.
+
Use case ends
