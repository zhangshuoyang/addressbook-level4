...
+
image:addsecondphone.png[width="700"]
* `edit 1 p/91234567 p2/73624789 e/johndoe@example.com`
+
image:addsecondphone2.png[width="700"]
...
=== Tab Switching [Since v1.5][[switch-tab]]
...
==== Examples
. Before entering any command, you are at the `Task` tab.
+
image:switchTab1.png[width="800"]

. Enter command `delete 1/2` and press kbd:[ENTER].
+
image:switchTab2.png[width="800"]

. The tab will be automatically switched to the `Map` tab.
+
