...
=== Add second phone number for a person
...
=== Locating persons by multiple criteria: `multifilter`
...
****
* Deletes the tag with the specified `tag_name` from all records.
****
...
=== Add no-English words as input (Coming in V2.0)
