...
[[extended-autocomplete-feature]] Try to save some time? Autocomplete is designed for you to operate efficiently on Contact Plus.Some commands such as `add` are very long and difficult to type.
...
=== List tasks [Since v1.4]

//tag::listtask-command[]

[[listtask]] This command enables you to retrieve personal tasks that you have stored in
`Contact Plus`. +
...
=======
>>>>>>> acbcf8d14d2cb1fe3f3df0bf667d5a09a0cda551
