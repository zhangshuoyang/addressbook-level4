...
Shows all the contacts that you have added to address book. +
...
Deletes the person, that you have specified, from the address book. +
...
tags from all your contacts in address book! +
...
Press a shorcut key to automatically complete the command that you enter into the command box. +
Format: [Prefix] +
...
This command allows you to delete *multiple* contacts from the address book in a
single command. +
