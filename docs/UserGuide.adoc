...
=== Deleting multiple person : `delete index/another index/...` [since v1.2]
...
image::DeleteMultiple/delete_image_1.png[width="500"]
_Figure 3.13.1 : All the contacts are listed_

2) `delete 2/3` deletes the 2nd and 3rd person from the address book. +

image::DeleteMultiple/delete_image_2.png[width="500"]
_Figure 3.13.2 : Contacts with index 2 & 3 are deleted_
